...
public extension SpanAttributes {
    ...
    var opentracing: OpentracingAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct OpentracingAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var ref_type: Self.Key<Ref_TypeEnum> { .init(name: SemConv.opentracing.ref_type) }
