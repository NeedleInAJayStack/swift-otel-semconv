...
public extension SpanAttributes {
    ...
    var aspnetcore: AspnetcoreAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct AspnetcoreAttributes: SpanAttributeNamespace {
        ...
        public struct DiagnosticsAttributes: SpanAttributeNamespace {
            ...
            public struct ExceptionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `handled`
                    ///     - `unhandled`
                    public var result: Self.Key<ResultEnum> { .init(name: SemConv.aspnetcore.diagnostics.exception.result) }
            ...
            public struct HandlerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var type: Self.Key<String> { .init(name: SemConv.aspnetcore.diagnostics.handler.type) }
                }
            }
        }
        ...
        public struct RateLimitingAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `sliding`
                ///     - `token`
                public var policy: Self.Key<String> { .init(name: SemConv.aspnetcore.rate_limiting.policy) }
                ...
                ///     - `acquired`
                ///     - `request_canceled`
                public var result: Self.Key<ResultEnum> { .init(name: SemConv.aspnetcore.rate_limiting.result) }

                public enum ResultEnum: String, SpanAttributeConvertible {
                    /// `acquired`: Lease was acquired
                    case acquired
                    /// `endpoint_limiter`: Lease request was rejected by the endpoint limiter
                    case endpoint_limiter
                    /// `global_limiter`: Lease request was rejected by the global limiter
                    case global_limiter
                    /// `request_canceled`: Lease request was canceled
        ...
        public struct RequestAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `true`
                public var is_unhandled: Self.Key<Bool> { .init(name: SemConv.aspnetcore.request.is_unhandled) }
            }
        }
        ...
        public struct RoutingAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `true`
                public var is_fallback: Self.Key<Bool> { .init(name: SemConv.aspnetcore.routing.is_fallback) }
                ...
                ///     - `success`
                ///     - `failure`
                public var match_status: Self.Key<Match_StatusEnum> { .init(name: SemConv.aspnetcore.routing.match_status) }
