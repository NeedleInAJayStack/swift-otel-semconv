...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct LogAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var iostream: Self.Key<IostreamEnum> { .init(name: SemConv.log.iostream) }
        ...
        public struct FileAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `audit.log`
                public var name: Self.Key<String> { .init(name: SemConv.log.file.name) }
                ...
                ///
                /// - Example: `uuid.log`
                public var name_resolved: Self.Key<String> { .init(name: SemConv.log.file.name_resolved) }
                ...
                public var path: Self.Key<String> { .init(name: SemConv.log.file.path) }
                ...
                public var path_resolved: Self.Key<String> { .init(name: SemConv.log.file.path_resolved) }
            }
        }
        ...
        public struct RecordAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var original: Self.Key<String> { .init(name: SemConv.log.record.original) }
                ...
                public var uid: Self.Key<String> { .init(name: SemConv.log.record.uid) }
            }
        }
    }
}
