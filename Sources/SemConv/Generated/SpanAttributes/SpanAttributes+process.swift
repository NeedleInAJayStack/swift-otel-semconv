...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct ProcessAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///
            /// - Example: `4`
            public var args_count: Self.Key<Int> { .init(name: SemConv.process.args_count) }
            ...
            ///
            /// - Example: `cmd/otelcol`
            public var command: Self.Key<String> { .init(name: SemConv.process.command) }
            ...
            ///
            /// - Type: stringArray
            public var command_args: Self.Key<[String]> { .init(name: SemConv.process.command_args) }
            ...
            public var command_line: Self.Key<String> { .init(name: SemConv.process.command_line) }
            ...
            ///     - `voluntary`
            ///     - `involuntary`
            public var context_switch_type: Self.Key<Context_Switch_TypeEnum> { .init(name: SemConv.process.context_switch_type) }
            ...
            ///
            /// - Type: boolean
            public var interactive: Self.Key<Bool> { .init(name: SemConv.process.interactive) }
            ...
            ///
            /// - Example: `root`
            public var owner: Self.Key<String> { .init(name: SemConv.process.owner) }
            ...
            ///
            /// - Example: `111`
            public var parent_pid: Self.Key<Int> { .init(name: SemConv.process.parent_pid) }
            ...
            ///
            /// - Example: `1234`
            public var pid: Self.Key<Int> { .init(name: SemConv.process.pid) }
            ...
            ///     - `xfce4-session`
            ///     - `bash`
            public var title: Self.Key<String> { .init(name: SemConv.process.title) }
            ...
            ///
            /// - Example: `12`
            public var vpid: Self.Key<Int> { .init(name: SemConv.process.vpid) }
            ...
            ///
            /// - Example: `/root`
            public var working_directory: Self.Key<String> { .init(name: SemConv.process.working_directory) }
        }
        ...
        public struct CpuAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var state: Self.Key<StateEnum> { .init(name: SemConv.process.cpu.state) }
        ...
        public struct CreationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var time: Self.Key<String> { .init(name: SemConv.process.creation.time) }
            }
        }
        ...
        public struct ExecutableAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `otelcol`
                public var name: Self.Key<String> { .init(name: SemConv.process.executable.name) }
                ...
                public var path: Self.Key<String> { .init(name: SemConv.process.executable.path) }
            }
            ...
            public struct BuildIdAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var gnu: Self.Key<String> { .init(name: SemConv.process.executable.build_id.gnu) }
        ...
        public struct ExitAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `127`
                public var code: Self.Key<Int> { .init(name: SemConv.process.exit.code) }
                ...
                public var time: Self.Key<String> { .init(name: SemConv.process.exit.time) }
            }
        }
        ...
        public struct PagingAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `major`
                ///     - `minor`
                public var fault_type: Self.Key<Fault_TypeEnum> { .init(name: SemConv.process.paging.fault_type) }
        ...
        public struct RealUserAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `1000`
                public var id: Self.Key<Int> { .init(name: SemConv.process.real_user.id) }
                ...
                ///
                /// - Example: `operator`
                public var name: Self.Key<String> { .init(name: SemConv.process.real_user.name) }
            }
        }
        ...
        public struct RuntimeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var description: Self.Key<String> { .init(name: SemConv.process.runtime.description) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.process.runtime.name) }
                ...
                ///
                /// - Example: `14.0.2`
                public var version: Self.Key<String> { .init(name: SemConv.process.runtime.version) }
            }
        }
        ...
        public struct SavedUserAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `1002`
                public var id: Self.Key<Int> { .init(name: SemConv.process.saved_user.id) }
                ...
                ///
                /// - Example: `operator`
                public var name: Self.Key<String> { .init(name: SemConv.process.saved_user.name) }
            }
        }
        ...
        public struct SessionLeaderAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `14`
                public var pid: Self.Key<Int> { .init(name: SemConv.process.session_leader.pid) }
            }
        }
        ...
        public struct UserAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `1001`
                public var id: Self.Key<Int> { .init(name: SemConv.process.user.id) }
                ...
                ///
                /// - Example: `root`
                public var name: Self.Key<String> { .init(name: SemConv.process.user.name) }
            }
        }
    }
}
