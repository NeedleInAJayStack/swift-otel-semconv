...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct SourceAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `10.1.2.80`
            ///     - `/tmp/my.sock`
            public var address: Self.Key<String> { .init(name: SemConv.source.address) }
            ...
            ///     - `3389`
            ///     - `2888`
            public var port: Self.Key<Int> { .init(name: SemConv.source.port) }
        }
    }
}
