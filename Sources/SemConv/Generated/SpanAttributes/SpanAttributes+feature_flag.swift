...
public extension SpanAttributes {
    ...
    var feature_flag: FeatureFlagAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct FeatureFlagAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///
            /// - Example: `logo-color`
            public var key: Self.Key<String> { .init(name: SemConv.feature_flag.key) }
            ...
            public var provider_name: Self.Key<String> { .init(name: SemConv.feature_flag.provider_name) }
            ...
            ///     - `true`
            ///     - `on`
            public var variant: Self.Key<String> { .init(name: SemConv.feature_flag.variant) }
            ...
            ///     - `1`
            ///     - `01ABCDEF`
            public var version: Self.Key<String> { .init(name: SemConv.feature_flag.version) }
        }
        ...
        public struct ContextAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.feature_flag.context.id) }
            }
        }
        ...
        public struct EvaluationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `error`
                ///     - `default`
                public var reason: Self.Key<ReasonEnum> { .init(name: SemConv.feature_flag.evaluation.reason) }
            ...
            public struct ErrorAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var message: Self.Key<String> { .init(name: SemConv.feature_flag.evaluation.error.message) }
                }
            }
        }
        ...
        public struct SetAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `ab98sgs`
                ///     - `service1/dev`
                public var id: Self.Key<String> { .init(name: SemConv.feature_flag.set.id) }
            }
        }
    }
}
