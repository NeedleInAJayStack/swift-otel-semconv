...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct VcsAttributes: SpanAttributeNamespace {
        ...
        public struct ChangeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `123`
                public var id: Self.Key<String> { .init(name: SemConv.vcs.change.id) }
                ...
                ///     - `closed`
                ///     - `merged`
                public var state: Self.Key<StateEnum> { .init(name: SemConv.vcs.change.state) }
                ...
                public var title: Self.Key<String> { .init(name: SemConv.vcs.change.title) }
            }
        }
        ...
        public struct LineChangeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `added`
                ///     - `removed`
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.vcs.line_change.type) }
        ...
        public struct RefAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `branch`
                ///     - `tag`
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.vcs.ref.type) }
            ...
            public struct BaseAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `my-feature-branch`
                    ///     - `tag-1-test`
                    public var name: Self.Key<String> { .init(name: SemConv.vcs.ref.base.name) }
                    ...
                    ///     - `123`
                    ///     - `HEAD`
                    public var revision: Self.Key<String> { .init(name: SemConv.vcs.ref.base.revision) }
                    ...
                    ///     - `branch`
                    ///     - `tag`
                    public var type: Self.Key<TypeEnum> { .init(name: SemConv.vcs.ref.base.type) }
            ...
            public struct HeadAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `my-feature-branch`
                    ///     - `tag-1-test`
                    public var name: Self.Key<String> { .init(name: SemConv.vcs.ref.head.name) }
                    ...
                    ///     - `123`
                    ///     - `HEAD`
                    public var revision: Self.Key<String> { .init(name: SemConv.vcs.ref.head.revision) }
                    ...
                    ///     - `branch`
                    ///     - `tag`
                    public var type: Self.Key<TypeEnum> { .init(name: SemConv.vcs.ref.head.type) }
        ...
        public struct RevisionDeltaAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `ahead`
                ///     - `behind`
                public var direction: Self.Key<DirectionEnum> { .init(name: SemConv.vcs.revision_delta.direction) }
