...
public extension SpanAttributes {
    ...
    var cloudfoundry: CloudfoundryAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct CloudfoundryAttributes: SpanAttributeNamespace {
        ...
        public struct AppAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.app.id) }
                ...
                ///
                /// - Example: `my-app-name`
                public var name: Self.Key<String> { .init(name: SemConv.cloudfoundry.app.name) }
            }
            ...
            public struct InstanceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `0`
                    ///     - `1`
                    public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.app.instance.id) }
                }
            }
        }
        ...
        public struct OrgAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.org.id) }
                ...
                ///
                /// - Example: `my-org-name`
                public var name: Self.Key<String> { .init(name: SemConv.cloudfoundry.org.name) }
            }
        }
        ...
        public struct ProcessAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.process.id) }
                ...
                ///
                /// - Example: `web`
                public var type: Self.Key<String> { .init(name: SemConv.cloudfoundry.process.type) }
            }
        }
        ...
        public struct SpaceAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.space.id) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.cloudfoundry.space.name) }
            }
        }
        ...
        public struct SystemAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `cf/gorouter`
                public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.system.id) }
            }
            ...
            public struct InstanceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                    public var id: Self.Key<String> { .init(name: SemConv.cloudfoundry.system.instance.id) }
                }
            }
        }
    }
