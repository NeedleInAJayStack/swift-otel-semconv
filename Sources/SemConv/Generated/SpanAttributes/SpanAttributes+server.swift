...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct ServerAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `10.1.2.80`
            ///     - `/tmp/my.sock`
            public var address: Self.Key<String> { .init(name: SemConv.server.address) }
            ...
            ///     - `8080`
            ///     - `443`
            public var port: Self.Key<Int> { .init(name: SemConv.server.port) }
        }
    }
}
