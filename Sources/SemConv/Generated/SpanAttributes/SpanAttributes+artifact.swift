...
public extension SpanAttributes {
    /// `artifact` namespace
    var artifact: ArtifactAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct ArtifactAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var filename: Self.Key<String> { .init(name: SemConv.artifact.filename) }
            ...
            public var hash: Self.Key<String> { .init(name: SemConv.artifact.hash) }
            ...
            ///     - `pkg:npm/foo@12.12.3`
            public var purl: Self.Key<String> { .init(name: SemConv.artifact.purl) }
            ...
            ///     - `1.2.1`
            ///     - `122691-build`
            public var version: Self.Key<String> { .init(name: SemConv.artifact.version) }
        }
        ...
        public struct AttestationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var filename: Self.Key<String> { .init(name: SemConv.artifact.attestation.filename) }
                ...
                public var hash: Self.Key<String> { .init(name: SemConv.artifact.attestation.hash) }
                ...
                ///
                /// - Example: `123`
                public var id: Self.Key<String> { .init(name: SemConv.artifact.attestation.id) }
            }
        }
    }
}
