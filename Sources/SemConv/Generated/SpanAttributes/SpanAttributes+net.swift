...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct NetAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var transport: Self.Key<TransportEnum> { .init(name: SemConv.net.transport) }
        ...
        public struct HostAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var ip: Self.Key<String> { .init(name: SemConv.net.host.ip) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.net.host.name) }
                ...
                public var port: Self.Key<Int> { .init(name: SemConv.net.host.port) }
            }
        }
        ...
        public struct PeerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var ip: Self.Key<String> { .init(name: SemConv.net.peer.ip) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.net.peer.name) }
                ...
                public var port: Self.Key<Int> { .init(name: SemConv.net.peer.port) }
            }
        }
        ...
        public struct ProtocolAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var name: Self.Key<String> { .init(name: SemConv.net.protocol.name) }
                ...
                public var version: Self.Key<String> { .init(name: SemConv.net.protocol.version) }
            }
        }
        ...
        public struct SockAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var family: Self.Key<FamilyEnum> { .init(name: SemConv.net.sock.family) }
            ...
            public struct HostAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// - Example: `/var/my.sock`
                    @available(*, deprecated, message: "Replaced by `network.local.address`.")
                    public var addr: Self.Key<String> { .init(name: SemConv.net.sock.host.addr) }
                    ...
                    public var port: Self.Key<Int> { .init(name: SemConv.net.sock.host.port) }
                }
            }
            ...
            public struct PeerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// - Example: `192.168.0.1`
                    @available(*, deprecated, message: "Replaced by `network.peer.address`.")
                    public var addr: Self.Key<String> { .init(name: SemConv.net.sock.peer.addr) }
                    ...
                    public var name: Self.Key<String> { .init(name: SemConv.net.sock.peer.name) }
                    ...
                    public var port: Self.Key<Int> { .init(name: SemConv.net.sock.peer.port) }
                }
            }
        }
    }
