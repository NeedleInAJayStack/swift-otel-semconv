...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct BrowserAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var brands: Self.Key<[String]> { .init(name: SemConv.browser.brands) }
            ...
            ///     - `fr`
            ///     - `fr-FR`
            public var language: Self.Key<String> { .init(name: SemConv.browser.language) }
            ...
            public var mobile: Self.Key<Bool> { .init(name: SemConv.browser.mobile) }
            ...
            ///     - `macOS`
            ///     - `Android`
            public var platform: Self.Key<String> { .init(name: SemConv.browser.platform) }
        }
    }
}
