...
extension SpanAttributes {
    ...
    public struct HttpAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var client_ip: Self.Key<String> { .init(name: SemConv.http.client_ip) }
            ...
            public var flavor: Self.Key<FlavorEnum> { .init(name: SemConv.http.flavor) }
            ...
            public var host: Self.Key<String> { .init(name: SemConv.http.host) }
            ...
            public var method: Self.Key<String> { .init(name: SemConv.http.method) }
            ...
            public var request_content_length: Self.Key<Int> { .init(name: SemConv.http.request_content_length) }
            ...
            public var request_content_length_uncompressed: Self.Key<Int> { .init(name: SemConv.http.request_content_length_uncompressed) }
            ...
            public var response_content_length: Self.Key<Int> { .init(name: SemConv.http.response_content_length) }
            ...
            public var response_content_length_uncompressed: Self.Key<Int> { .init(name: SemConv.http.response_content_length_uncompressed) }
            ...
            public var route: Self.Key<String> { .init(name: SemConv.http.route) }
            ...
            public var scheme: Self.Key<String> { .init(name: SemConv.http.scheme) }
            ...
            public var server_name: Self.Key<String> { .init(name: SemConv.http.server_name) }
            ...
            public var status_code: Self.Key<Int> { .init(name: SemConv.http.status_code) }
            ...
            public var target: Self.Key<String> { .init(name: SemConv.http.target) }
            ...
            public var url: Self.Key<String> { .init(name: SemConv.http.url) }
            ...
            public var user_agent: Self.Key<String> { .init(name: SemConv.http.user_agent) }
        }
        ...
        public struct ConnectionAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `active`
                ///     - `idle`
                public var state: Self.Key<StateEnum> { .init(name: SemConv.http.connection.state) }
        ...
        public struct RequestAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `POST`
                ///     - `HEAD`
                public var method: Self.Key<MethodEnum> { .init(name: SemConv.http.request.method) }
                ...
                ///     - `ACL`
                ///     - `foo`
                public var method_original: Self.Key<String> { .init(name: SemConv.http.request.method_original) }
                ...
                /// 
                /// - Example: `3`
                public var resend_count: Self.Key<Int> { .init(name: SemConv.http.request.resend_count) }
                ...
                /// 
                /// - Example: `1437`
                public var size: Self.Key<Int> { .init(name: SemConv.http.request.size) }
            }
            ...
            public struct BodyAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `3495`
                    public var size: Self.Key<Int> { .init(name: SemConv.http.request.body.size) }
                }
        ...
        public struct ResponseAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `1437`
                public var size: Self.Key<Int> { .init(name: SemConv.http.response.size) }
                ...
                /// 
                /// - Example: `200`
                public var status_code: Self.Key<Int> { .init(name: SemConv.http.response.status_code) }
            }
            ...
            public struct BodyAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `3495`
                    public var size: Self.Key<Int> { .init(name: SemConv.http.response.body.size) }
                }
