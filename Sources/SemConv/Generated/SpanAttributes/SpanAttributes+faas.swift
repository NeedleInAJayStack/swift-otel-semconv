...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct FaasAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///
            /// - Type: boolean
            public var coldstart: Self.Key<Bool> { .init(name: SemConv.faas.coldstart) }
            ...
            ///
            /// - Example: `0/5 * * * ? *`
            public var cron: Self.Key<String> { .init(name: SemConv.faas.cron) }
            ...
            public var instance: Self.Key<String> { .init(name: SemConv.faas.instance) }
            ...
            public var invocation_id: Self.Key<String> { .init(name: SemConv.faas.invocation_id) }
            ...
            ///
            /// - Example: `my-function`
            public var invoked_name: Self.Key<String> { .init(name: SemConv.faas.invoked_name) }
            ...
            public var invoked_provider: Self.Key<Invoked_ProviderEnum> { .init(name: SemConv.faas.invoked_provider) }
            ...
            public var invoked_region: Self.Key<String> { .init(name: SemConv.faas.invoked_region) }
            ...
            ///
            /// - Example: `134217728`
            public var max_memory: Self.Key<Int> { .init(name: SemConv.faas.max_memory) }
            ...
            public var name: Self.Key<String> { .init(name: SemConv.faas.name) }
            ...
            public var time: Self.Key<String> { .init(name: SemConv.faas.time) }
            ...
            public var trigger: Self.Key<TriggerEnum> { .init(name: SemConv.faas.trigger) }
            ...
            ///     - `26`
            ///     - `pinkfroid-00002`
            public var version: Self.Key<String> { .init(name: SemConv.faas.version) }
        }
        ...
        public struct DocumentAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `myBucketName`
                ///     - `myDbName`
                public var collection: Self.Key<String> { .init(name: SemConv.faas.document.collection) }
                ...
                ///     - `myFile.txt`
                ///     - `myTableName`
                public var name: Self.Key<String> { .init(name: SemConv.faas.document.name) }
                ...
                public var operation: Self.Key<OperationEnum> { .init(name: SemConv.faas.document.operation) }
                ...
                ///
                /// - Example: `2020-01-23T13:47:06Z`
                public var time: Self.Key<String> { .init(name: SemConv.faas.document.time) }
            }
        }
    }
}
