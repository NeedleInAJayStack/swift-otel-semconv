...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct AwsAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `C9ER4AJX75574TDJ`
            public var request_id: Self.Key<String> { .init(name: SemConv.aws.request_id) }
        }
        ...
        public struct DynamodbAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Type: stringArray
                public var attribute_definitions: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.attribute_definitions) }
                ...
                ///
                /// - Type: stringArray
                public var attributes_to_get: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.attributes_to_get) }
                ...
                ///
                /// - Type: boolean
                public var consistent_read: Self.Key<Bool> { .init(name: SemConv.aws.dynamodb.consistent_read) }
                ...
                ///
                /// - Type: stringArray
                public var consumed_capacity: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.consumed_capacity) }
                ...
                ///
                /// - Example: `10`
                public var count: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.count) }
                ...
                ///     - `Users`
                ///     - `CatsTable`
                public var exclusive_start_table: Self.Key<String> { .init(name: SemConv.aws.dynamodb.exclusive_start_table) }
                ...
                ///
                /// - Type: stringArray
                public var global_secondary_index_updates: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.global_secondary_index_updates) }
                ...
                ///
                /// - Type: stringArray
                public var global_secondary_indexes: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.global_secondary_indexes) }
                ...
                public var index_name: Self.Key<String> { .init(name: SemConv.aws.dynamodb.index_name) }
                ...
                public var item_collection_metrics: Self.Key<String> { .init(name: SemConv.aws.dynamodb.item_collection_metrics) }
                ...
                ///
                /// - Example: `10`
                public var limit: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.limit) }
                ...
                ///
                /// - Type: stringArray
                public var local_secondary_indexes: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.local_secondary_indexes) }
                ...
                public var projection: Self.Key<String> { .init(name: SemConv.aws.dynamodb.projection) }
                ...
                ///     - `1.0`
                ///     - `2.0`
                public var provisioned_read_capacity: Self.Key<Double> { .init(name: SemConv.aws.dynamodb.provisioned_read_capacity) }
                ...
                ///     - `1.0`
                ///     - `2.0`
                public var provisioned_write_capacity: Self.Key<Double> { .init(name: SemConv.aws.dynamodb.provisioned_write_capacity) }
                ...
                ///
                /// - Type: boolean
                public var scan_forward: Self.Key<Bool> { .init(name: SemConv.aws.dynamodb.scan_forward) }
                ...
                ///
                /// - Example: `50`
                public var scanned_count: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.scanned_count) }
                ...
                ///
                /// - Example: `10`
                public var segment: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.segment) }
                ...
                ///     - `ALL_ATTRIBUTES`
                ///     - `COUNT`
                public var select: Self.Key<String> { .init(name: SemConv.aws.dynamodb.select) }
                ...
                ///
                /// - Example: `20`
                public var table_count: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.table_count) }
                ...
                ///
                /// - Type: stringArray
                public var table_names: Self.Key<[String]> { .init(name: SemConv.aws.dynamodb.table_names) }
                ...
                ///
                /// - Example: `100`
                public var total_segments: Self.Key<Int> { .init(name: SemConv.aws.dynamodb.total_segments) }
            }
        }
        ...
        public struct EcsAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `ec2`
                ///     - `fargate`
                public var launchtype: Self.Key<LaunchtypeEnum> { .init(name: SemConv.aws.ecs.launchtype) }
            ...
            public struct ClusterAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var arn: Self.Key<String> { .init(name: SemConv.aws.ecs.cluster.arn) }
                }
            }
            ...
            public struct ContainerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var arn: Self.Key<String> { .init(name: SemConv.aws.ecs.container.arn) }
                }
            }
            ...
            public struct TaskAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var arn: Self.Key<String> { .init(name: SemConv.aws.ecs.task.arn) }
                    ...
                    public var family: Self.Key<String> { .init(name: SemConv.aws.ecs.task.family) }
                    ...
                    public var id: Self.Key<String> { .init(name: SemConv.aws.ecs.task.id) }
                    ...
                    ///     - `8`
                    ///     - `26`
                    public var revision: Self.Key<String> { .init(name: SemConv.aws.ecs.task.revision) }
                }
            }
        }
        ...
        public struct EksAttributes: SpanAttributeNamespace {
            ...
            public struct ClusterAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `arn:aws:ecs:us-west-2:123456789123:cluster/my-cluster`
                    public var arn: Self.Key<String> { .init(name: SemConv.aws.eks.cluster.arn) }
                }
            }
        }
        ...
        public struct LambdaAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var invoked_arn: Self.Key<String> { .init(name: SemConv.aws.lambda.invoked_arn) }
            }
        }
        ...
        public struct LogAttributes: SpanAttributeNamespace {
            ...
            public struct GroupAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var arns: Self.Key<[String]> { .init(name: SemConv.aws.log.group.arns) }
                    ...
                    public var names: Self.Key<[String]> { .init(name: SemConv.aws.log.group.names) }
                }
            }
            ...
            public struct StreamAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var arns: Self.Key<[String]> { .init(name: SemConv.aws.log.stream.arns) }
                    ...
                    ///
                    /// - Type: stringArray
                    public var names: Self.Key<[String]> { .init(name: SemConv.aws.log.stream.names) }
                }
            }
        }
        ...
        public struct S3Attributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var bucket: Self.Key<String> { .init(name: SemConv.aws.s3.bucket) }
                ...
                public var copy_source: Self.Key<String> { .init(name: SemConv.aws.s3.copy_source) }
                ...
                public var delete: Self.Key<String> { .init(name: SemConv.aws.s3.delete) }
                ...
                ///
                /// - Example: `someFile.yml`
                public var key: Self.Key<String> { .init(name: SemConv.aws.s3.key) }
                ...
                ///
                /// - Example: `3456`
                public var part_number: Self.Key<Int> { .init(name: SemConv.aws.s3.part_number) }
                ...
                public var upload_id: Self.Key<String> { .init(name: SemConv.aws.s3.upload_id) }
            }
        }
    }
}
