...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct OtelAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var status_code: Self.Key<Status_CodeEnum> { .init(name: SemConv.otel.status_code) }
            ...
            public var status_description: Self.Key<String> { .init(name: SemConv.otel.status_description) }
        }
        ...
        public struct LibraryAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var name: Self.Key<String> { .init(name: SemConv.otel.library.name) }
                ...
                public var version: Self.Key<String> { .init(name: SemConv.otel.library.version) }
            }
        }
        ...
        public struct ScopeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `io.opentelemetry.contrib.mongodb`
                public var name: Self.Key<String> { .init(name: SemConv.otel.scope.name) }
                ...
                ///
                /// - Example: `1.0.0`
                public var version: Self.Key<String> { .init(name: SemConv.otel.scope.version) }
            }
        }
    }
}
