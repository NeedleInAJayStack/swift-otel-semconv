...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct HerokuAttributes: SpanAttributeNamespace {
        ...
        public struct AppAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.heroku.app.id) }
            }
        }
        ...
        public struct ReleaseAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var commit: Self.Key<String> { .init(name: SemConv.heroku.release.commit) }
                ...
                public var creation_timestamp: Self.Key<String> { .init(name: SemConv.heroku.release.creation_timestamp) }
            }
        }
    }
}
