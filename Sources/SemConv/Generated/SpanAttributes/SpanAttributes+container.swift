...
public extension SpanAttributes {
    /// `container` namespace
    var container: ContainerAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct ContainerAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var command: Self.Key<String> { .init(name: SemConv.container.command) }
            ...
            ///
            /// - Type: stringArray
            public var command_args: Self.Key<[String]> { .init(name: SemConv.container.command_args) }
            ...
            public var command_line: Self.Key<String> { .init(name: SemConv.container.command_line) }
            ...
            public var id: Self.Key<String> { .init(name: SemConv.container.id) }
            ...
            public var name: Self.Key<String> { .init(name: SemConv.container.name) }
            ...
            ///     - `containerd`
            ///     - `rkt`
            public var runtime: Self.Key<String> { .init(name: SemConv.container.runtime) }
        }
        ...
        public struct CpuAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var state: Self.Key<StateEnum> { .init(name: SemConv.container.cpu.state) }
        ...
        public struct CsiAttributes: SpanAttributeNamespace {
            ...
            public struct PluginAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<String> { .init(name: SemConv.container.csi.plugin.name) }
                }
            }
            ...
            public struct VolumeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var id: Self.Key<String> { .init(name: SemConv.container.csi.volume.id) }
                }
            }
        }
        ...
        public struct ImageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.container.image.id) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.container.image.name) }
                ...
                public var repo_digests: Self.Key<[String]> { .init(name: SemConv.container.image.repo_digests) }
                ...
                ///
                /// - Type: stringArray
                public var tags: Self.Key<[String]> { .init(name: SemConv.container.image.tags) }
            }
        }
    }
}
