...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct UrlAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var domain: Self.Key<String> { .init(name: SemConv.url.domain) }
            ...
            ///     - `png`
            ///     - `gz`
            public var `extension`: Self.Key<String> { .init(name: SemConv.url.extension) }
            ...
            ///
            /// - Example: `SemConv`
            public var fragment: Self.Key<String> { .init(name: SemConv.url.fragment) }
            ...
            ///     - `//localhost`
            public var full: Self.Key<String> { .init(name: SemConv.url.full) }
            ...
            public var original: Self.Key<String> { .init(name: SemConv.url.original) }
            ...
            ///
            /// - Example: `/search`
            public var path: Self.Key<String> { .init(name: SemConv.url.path) }
            ...
            ///
            /// - Example: `443`
            public var port: Self.Key<Int> { .init(name: SemConv.url.port) }
            ...
            public var query: Self.Key<String> { .init(name: SemConv.url.query) }
            ...
            ///     - `example.com`
            ///     - `foo.co.uk`
            public var registered_domain: Self.Key<String> { .init(name: SemConv.url.registered_domain) }
            ...
            ///     - `ftp`
            ///     - `telnet`
            public var scheme: Self.Key<String> { .init(name: SemConv.url.scheme) }
            ...
            ///     - `east`
            ///     - `sub2.sub1`
            public var subdomain: Self.Key<String> { .init(name: SemConv.url.subdomain) }
            ...
            ///     - `/users/:id`
            ///     - `/users?id={id}`
            public var template: Self.Key<String> { .init(name: SemConv.url.template) }
            ...
            ///     - `com`
            ///     - `co.uk`
            public var top_level_domain: Self.Key<String> { .init(name: SemConv.url.top_level_domain) }
        }
    }
}
