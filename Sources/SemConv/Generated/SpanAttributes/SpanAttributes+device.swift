...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct DeviceAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var id: Self.Key<String> { .init(name: SemConv.device.id) }
            ...
            ///     - `Apple`
            ///     - `Samsung`
            public var manufacturer: Self.Key<String> { .init(name: SemConv.device.manufacturer) }
        }
        ...
        public struct ModelAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `iPhone3,4`
                ///     - `SM-G920F`
                public var identifier: Self.Key<String> { .init(name: SemConv.device.model.identifier) }
                ...
                ///     - `iPhone 6s Plus`
                ///     - `Samsung Galaxy S6`
                public var name: Self.Key<String> { .init(name: SemConv.device.model.name) }
            }
        }
    }
}
