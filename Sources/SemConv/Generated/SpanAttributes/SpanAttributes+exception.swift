...
public extension SpanAttributes {
    /// `exception` namespace
    var exception: ExceptionAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct ExceptionAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var escaped: Self.Key<Bool> { .init(name: SemConv.exception.escaped) }
            ...
            public var message: Self.Key<String> { .init(name: SemConv.exception.message) }
            ...
            /// `
            public var stacktrace: Self.Key<String> { .init(name: SemConv.exception.stacktrace) }
            ...
            ///     - `OSError`
            public var type: Self.Key<String> { .init(name: SemConv.exception.type) }
        }
    }
}
