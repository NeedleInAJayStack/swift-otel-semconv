...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct RpcAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var method: Self.Key<String> { .init(name: SemConv.rpc.method) }
            ...
            public var service: Self.Key<String> { .init(name: SemConv.rpc.service) }
            ...
            public var system: Self.Key<SystemEnum> { .init(name: SemConv.rpc.system) }
        ...
        public struct ConnectRpcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `data_loss`
                ///     - `unauthenticated`
                public var error_code: Self.Key<Error_CodeEnum> { .init(name: SemConv.rpc.connect_rpc.error_code) }
        ...
        public struct GrpcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `15`: DATA_LOSS
                ///     - `16`: UNAUTHENTICATED
                public var status_code: Self.Key<Status_CodeEnum> { .init(name: SemConv.rpc.grpc.status_code) }
        ...
        public struct JsonrpcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `-32700`
                ///     - `100`
                public var error_code: Self.Key<Int> { .init(name: SemConv.rpc.jsonrpc.error_code) }
                ...
                ///     - `Parse error`
                ///     - `User already exists`
                public var error_message: Self.Key<String> { .init(name: SemConv.rpc.jsonrpc.error_message) }
                ...
                ///     - `request-7`
                ///     - ``
                public var request_id: Self.Key<String> { .init(name: SemConv.rpc.jsonrpc.request_id) }
                ...
                ///     - `2.0`
                ///     - `1.0`
                public var version: Self.Key<String> { .init(name: SemConv.rpc.jsonrpc.version) }
            }
        }
        ...
        public struct MessageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Type: int
                public var compressed_size: Self.Key<Int> { .init(name: SemConv.rpc.message.compressed_size) }
                ...
                public var id: Self.Key<Int> { .init(name: SemConv.rpc.message.id) }
                ...
                ///     - `SENT`
                ///     - `RECEIVED`
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.rpc.message.type) }
                ...
                ///
                /// - Type: int
                public var uncompressed_size: Self.Key<Int> { .init(name: SemConv.rpc.message.uncompressed_size) }
            }
        }
    }
}
