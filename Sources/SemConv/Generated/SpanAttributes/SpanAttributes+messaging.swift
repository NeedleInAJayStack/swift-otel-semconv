...
public extension SpanAttributes {
    /// `messaging` namespace
    var messaging: MessagingAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct MessagingAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var client_id: Self.Key<String> { .init(name: SemConv.messaging.client_id) }
            ...
            public var _operation: Self.Key<String> { .init(name: SemConv.messaging._operation) }
            ...
            public var system: Self.Key<SystemEnum> { .init(name: SemConv.messaging.system) }
        ...
        public struct BatchAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `1`
                ///     - `2`
                public var message_count: Self.Key<Int> { .init(name: SemConv.messaging.batch.message_count) }
            }
        }
        ...
        public struct ClientAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `client-5`
                ///     - `myhost@8742@s8083jm`
                public var id: Self.Key<String> { .init(name: SemConv.messaging.client.id) }
            }
        }
        ...
        public struct ConsumerAttributes: SpanAttributeNamespace {
            ...
            public struct GroupAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `my-group`
                    ///     - `indexer`
                    public var name: Self.Key<String> { .init(name: SemConv.messaging.consumer.group.name) }
                }
            }
        }
        ...
        public struct DestinationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Type: boolean
                public var anonymous: Self.Key<Bool> { .init(name: SemConv.messaging.destination.anonymous) }
                ...
                ///     - `MyQueue`
                ///     - `MyTopic`
                public var name: Self.Key<String> { .init(name: SemConv.messaging.destination.name) }
                ...
                public var template: Self.Key<String> { .init(name: SemConv.messaging.destination.template) }
                ...
                ///
                /// - Type: boolean
                public var temporary: Self.Key<Bool> { .init(name: SemConv.messaging.destination.temporary) }
            }
            ...
            public struct PartitionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `1`
                    public var id: Self.Key<String> { .init(name: SemConv.messaging.destination.partition.id) }
                }
            }
            ...
            public struct SubscriptionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<String> { .init(name: SemConv.messaging.destination.subscription.name) }
                }
            }
        }
        ...
        public struct DestinationPublishAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var anonymous: Self.Key<Bool> { .init(name: SemConv.messaging.destination_publish.anonymous) }
                ...
                ///     - `MyTopic`
                @available(*, deprecated, message: "No replacement at this time.")
                public var name: Self.Key<String> { .init(name: SemConv.messaging.destination_publish.name) }
            }
        }
        ...
        public struct EventhubsAttributes: SpanAttributeNamespace {
            ...
            public struct ConsumerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var group: Self.Key<String> { .init(name: SemConv.messaging.eventhubs.consumer.group) }
                }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `1701393730`
                    public var enqueued_time: Self.Key<Int> { .init(name: SemConv.messaging.eventhubs.message.enqueued_time) }
                }
            }
        }
        ...
        public struct GcpPubsubAttributes: SpanAttributeNamespace {
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `10`
                    public var ack_deadline: Self.Key<Int> { .init(name: SemConv.messaging.gcp_pubsub.message.ack_deadline) }
                    ...
                    ///
                    /// - Example: `ack_id`
                    public var ack_id: Self.Key<String> { .init(name: SemConv.messaging.gcp_pubsub.message.ack_id) }
                    ...
                    ///
                    /// - Example: `2`
                    public var delivery_attempt: Self.Key<Int> { .init(name: SemConv.messaging.gcp_pubsub.message.delivery_attempt) }
                    ...
                    public var ordering_key: Self.Key<String> { .init(name: SemConv.messaging.gcp_pubsub.message.ordering_key) }
                }
            }
        }
        ...
        public struct KafkaAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `42`
                public var offset: Self.Key<Int> { .init(name: SemConv.messaging.kafka.offset) }
            }
            ...
            public struct ConsumerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// - Example: `my-group`
                    @available(*, deprecated, message: "Replaced by `messaging.consumer.group.name`.")
                    public var group: Self.Key<String> { .init(name: SemConv.messaging.kafka.consumer.group) }
                }
            }
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var partition: Self.Key<Int> { .init(name: SemConv.messaging.kafka.destination.partition) }
                }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `myKey`
                    public var key: Self.Key<String> { .init(name: SemConv.messaging.kafka.message.key) }
                    ...
                    public var offset: Self.Key<Int> { .init(name: SemConv.messaging.kafka.message.offset) }
                    ...
                    ///
                    /// - Type: boolean
                    public var tombstone: Self.Key<Bool> { .init(name: SemConv.messaging.kafka.message.tombstone) }
                }
            }
        }
        ...
        public struct MessageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var conversation_id: Self.Key<String> { .init(name: SemConv.messaging.message.conversation_id) }
                ...
                public var id: Self.Key<String> { .init(name: SemConv.messaging.message.id) }
            }
            ...
            public struct BodyAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `1439`
                    public var size: Self.Key<Int> { .init(name: SemConv.messaging.message.body.size) }
                }
            }
            ...
            public struct EnvelopeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `2738`
                    public var size: Self.Key<Int> { .init(name: SemConv.messaging.message.envelope.size) }
                }
            }
        }
        ...
        public struct OperationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `nack`
                ///     - `send`
                public var name: Self.Key<String> { .init(name: SemConv.messaging.operation.name) }
                ...
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.messaging.operation.type) }
        ...
        public struct RabbitmqAttributes: SpanAttributeNamespace {
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `myKey`
                    public var routing_key: Self.Key<String> { .init(name: SemConv.messaging.rabbitmq.destination.routing_key) }
                }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `123`
                    public var delivery_tag: Self.Key<Int> { .init(name: SemConv.messaging.rabbitmq.message.delivery_tag) }
                }
            }
        }
        ...
        public struct RocketmqAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var client_group: Self.Key<String> { .init(name: SemConv.messaging.rocketmq.client_group) }
                ...
                public var consumption_model: Self.Key<Consumption_ModelEnum> { .init(name: SemConv.messaging.rocketmq.consumption_model) }
                ...
                ///
                /// - Example: `myNamespace`
                public var namespace: Self.Key<String> { .init(name: SemConv.messaging.rocketmq.namespace) }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `3`
                    public var delay_time_level: Self.Key<Int> { .init(name: SemConv.messaging.rocketmq.message.delay_time_level) }
                    ...
                    public var delivery_timestamp: Self.Key<Int> { .init(name: SemConv.messaging.rocketmq.message.delivery_timestamp) }
                    ...
                    public var group: Self.Key<String> { .init(name: SemConv.messaging.rocketmq.message.group) }
                    ...
                    ///
                    /// - Type: stringArray
                    public var keys: Self.Key<[String]> { .init(name: SemConv.messaging.rocketmq.message.keys) }
                    ...
                    ///
                    /// - Example: `tagA`
                    public var tag: Self.Key<String> { .init(name: SemConv.messaging.rocketmq.message.tag) }
                    ...
                    public var type: Self.Key<TypeEnum> { .init(name: SemConv.messaging.rocketmq.message.type) }
        ...
        public struct ServicebusAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var disposition_status: Self.Key<Disposition_StatusEnum> { .init(name: SemConv.messaging.servicebus.disposition_status) }
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var subscription_name: Self.Key<String> { .init(name: SemConv.messaging.servicebus.destination.subscription_name) }
                }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `2`
                    public var delivery_count: Self.Key<Int> { .init(name: SemConv.messaging.servicebus.message.delivery_count) }
                    ...
                    ///
                    /// - Example: `1701393730`
                    public var enqueued_time: Self.Key<Int> { .init(name: SemConv.messaging.servicebus.message.enqueued_time) }
                }
            }
        }
    }
