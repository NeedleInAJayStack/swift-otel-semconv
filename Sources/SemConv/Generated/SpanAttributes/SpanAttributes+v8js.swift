...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct V8JsAttributes: SpanAttributeNamespace {
        ...
        public struct GcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.v8js.gc.type) }
        ...
        public struct HeapAttributes: SpanAttributeNamespace {
            ...
            public struct SpaceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<NameEnum> { .init(name: SemConv.v8js.heap.space.name) }
