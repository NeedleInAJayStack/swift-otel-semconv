...
public extension SpanAttributes {
    ...
    var destination: DestinationAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct DestinationAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `10.1.2.80`
            ///     - `/tmp/my.sock`
            public var address: Self.Key<String> { .init(name: SemConv.destination.address) }
            ...
            ///     - `3389`
            ///     - `2888`
            public var port: Self.Key<Int> { .init(name: SemConv.destination.port) }
        }
    }
}
