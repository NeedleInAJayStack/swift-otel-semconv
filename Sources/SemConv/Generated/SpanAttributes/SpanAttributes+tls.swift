...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct TlsAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var cipher: Self.Key<String> { .init(name: SemConv.tls.cipher) }
            ...
            ///
            /// - Example: `secp256r1`
            public var curve: Self.Key<String> { .init(name: SemConv.tls.curve) }
            ...
            ///
            /// - Example: `true`
            public var established: Self.Key<Bool> { .init(name: SemConv.tls.established) }
            ...
            ///
            /// - Example: `http/1.1`
            public var next_protocol: Self.Key<String> { .init(name: SemConv.tls.next_protocol) }
            ...
            ///
            /// - Example: `true`
            public var resumed: Self.Key<Bool> { .init(name: SemConv.tls.resumed) }
        }
        ...
        public struct ClientAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `MII...`
                public var certificate: Self.Key<String> { .init(name: SemConv.tls.client.certificate) }
                ...
                ///
                /// - Type: stringArray
                public var certificate_chain: Self.Key<[String]> { .init(name: SemConv.tls.client.certificate_chain) }
                ...
                public var issuer: Self.Key<String> { .init(name: SemConv.tls.client.issuer) }
                ...
                public var ja3: Self.Key<String> { .init(name: SemConv.tls.client.ja3) }
                ...
                public var not_after: Self.Key<String> { .init(name: SemConv.tls.client.not_after) }
                ...
                public var not_before: Self.Key<String> { .init(name: SemConv.tls.client.not_before) }
                ...
                public var server_name: Self.Key<String> { .init(name: SemConv.tls.client.server_name) }
                ...
                public var subject: Self.Key<String> { .init(name: SemConv.tls.client.subject) }
                ...
                ///
                /// - Type: stringArray
                public var supported_ciphers: Self.Key<[String]> { .init(name: SemConv.tls.client.supported_ciphers) }
            }
            ...
            public struct HashAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var md5: Self.Key<String> { .init(name: SemConv.tls.client.hash.md5) }
                    ...
                    public var sha1: Self.Key<String> { .init(name: SemConv.tls.client.hash.sha1) }
                    ...
                    public var sha256: Self.Key<String> { .init(name: SemConv.tls.client.hash.sha256) }
                }
            }
        }
        ...
        public struct ProtocolAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `ssl`
                ///     - `tls`
                public var name: Self.Key<NameEnum> { .init(name: SemConv.tls.protocol.name) }
                ...
                ///     - `1.2`
                ///     - `3`
                public var version: Self.Key<String> { .init(name: SemConv.tls.protocol.version) }
            }
        }
        ...
        public struct ServerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `MII...`
                public var certificate: Self.Key<String> { .init(name: SemConv.tls.server.certificate) }
                ...
                ///
                /// - Type: stringArray
                public var certificate_chain: Self.Key<[String]> { .init(name: SemConv.tls.server.certificate_chain) }
                ...
                ///
                /// - Example: `CN=Example Root CA, OU=Infrastructure Team, DC=example, DC=com`
                public var issuer: Self.Key<String> { .init(name: SemConv.tls.server.issuer) }
                ...
                ///
                /// - Example: `d4e5b18d6b55c71272893221c96ba240`
                public var ja3s: Self.Key<String> { .init(name: SemConv.tls.server.ja3s) }
                ...
                ///
                /// - Example: `2021-01-01T00:00:00.000Z`
                public var not_after: Self.Key<String> { .init(name: SemConv.tls.server.not_after) }
                ...
                ///
                /// - Example: `1970-01-01T00:00:00.000Z`
                public var not_before: Self.Key<String> { .init(name: SemConv.tls.server.not_before) }
                ...
                public var subject: Self.Key<String> { .init(name: SemConv.tls.server.subject) }
            }
            ...
            public struct HashAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `0F76C7F2C55BFD7D8E8B8F4BFBF0C9EC`
                    public var md5: Self.Key<String> { .init(name: SemConv.tls.server.hash.md5) }
                    ...
                    ///
                    /// - Example: `9E393D93138888D288266C2D915214D1D1CCEB2A`
                    public var sha1: Self.Key<String> { .init(name: SemConv.tls.server.hash.sha1) }
                    ...
                    ///
                    /// - Example: `0687F666A054EF17A08E2F2162EAB4CBC0D265E1D7875BE74BF3C712CA92DAF0`
                    public var sha256: Self.Key<String> { .init(name: SemConv.tls.server.hash.sha256) }
                }
            }
        }
    }
