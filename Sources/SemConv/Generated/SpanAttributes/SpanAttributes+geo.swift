...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct GeoAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///
            /// - Example: `94040`
            public var postal_code: Self.Key<String> { .init(name: SemConv.geo.postal_code) }
        }
        ...
        public struct ContinentAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `OC`: Oceania
                ///     - `SA`: South America
                public var code: Self.Key<CodeEnum> { .init(name: SemConv.geo.continent.code) }
        ...
        public struct CountryAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `CA`
                public var iso_code: Self.Key<String> { .init(name: SemConv.geo.country.iso_code) }
            }
        }
        ...
        public struct LocalityAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `Montreal`
                ///     - `Berlin`
                public var name: Self.Key<String> { .init(name: SemConv.geo.locality.name) }
            }
        }
        ...
        public struct LocationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `45.505918`
                public var lat: Self.Key<Double> { .init(name: SemConv.geo.location.lat) }
                ...
                ///
                /// - Example: `-73.614830`
                public var lon: Self.Key<Double> { .init(name: SemConv.geo.location.lon) }
            }
        }
        ...
        public struct RegionAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `CA-QC`
                public var iso_code: Self.Key<String> { .init(name: SemConv.geo.region.iso_code) }
            }
        }
    }
}
