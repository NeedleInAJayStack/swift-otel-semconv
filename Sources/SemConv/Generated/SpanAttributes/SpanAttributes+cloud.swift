...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct CloudAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///
            /// - Example: `us-east-1c`
            public var availability_zone: Self.Key<String> { .init(name: SemConv.cloud.availability_zone) }
            ...
            public var platform: Self.Key<PlatformEnum> { .init(name: SemConv.cloud.platform) }

            public enum PlatformEnum: String, SpanAttributeConvertible {
                /// `alibaba_cloud_ecs`: Alibaba Cloud Elastic Compute Service
                case alibaba_cloud_ecs
                /// `alibaba_cloud_fc`: Alibaba Cloud Function Compute
                case alibaba_cloud_fc
                /// `alibaba_cloud_openshift`: Red Hat OpenShift on Alibaba Cloud
                case alibaba_cloud_openshift
                /// `aws_ec2`: AWS Elastic Compute Cloud
                case aws_ec2
                /// `aws_ecs`: AWS Elastic Container Service
                case aws_ecs
                ...
                case gcp_openshift
                /// `ibm_cloud_openshift`: Red Hat OpenShift on IBM Cloud
                case ibm_cloud_openshift
                /// `tencent_cloud_cvm`: Tencent Cloud Cloud Virtual Machine (CVM)
                case tencent_cloud_cvm
                /// `tencent_cloud_eks`: Tencent Cloud Elastic Kubernetes Service (EKS)
                case tencent_cloud_eks
                /// `tencent_cloud_scf`: Tencent Cloud Serverless Cloud Function (SCF)
                case tencent_cloud_scf
            ...
            public var provider: Self.Key<ProviderEnum> { .init(name: SemConv.cloud.provider) }
            ...
            ///     - `us-central1`
            ///     - `us-east-1`
            public var region: Self.Key<String> { .init(name: SemConv.cloud.region) }
            ...
            public var resource_id: Self.Key<String> { .init(name: SemConv.cloud.resource_id) }
        }
        ...
        public struct AccountAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `111111111111`
                ///     - `opentelemetry`
                public var id: Self.Key<String> { .init(name: SemConv.cloud.account.id) }
            }
        }
    }
}
