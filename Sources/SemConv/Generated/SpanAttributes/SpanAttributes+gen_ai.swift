...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct GenAiAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var completion: Self.Key<String> { .init(name: SemConv.gen_ai.completion) }
            ...
            @available(*, deprecated, message: "Removed, no replacement at this time.")
            public var prompt: Self.Key<String> { .init(name: SemConv.gen_ai.prompt) }
            ...
            ///
            /// - Example: `openai`
            public var system: Self.Key<SystemEnum> { .init(name: SemConv.gen_ai.system) }
        ...
        public struct OpenaiAttributes: SpanAttributeNamespace {
            ...
            public struct RequestAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///
                    /// - Example: `json`
                    public var response_format: Self.Key<Response_FormatEnum> { .init(name: SemConv.gen_ai.openai.request.response_format) }
                    ...
                    ///     - `auto`
                    ///     - `default`
                    public var service_tier: Self.Key<Service_TierEnum> { .init(name: SemConv.gen_ai.openai.request.service_tier) }
        ...
        public struct RequestAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `0.1`
                public var frequency_penalty: Self.Key<Double> { .init(name: SemConv.gen_ai.request.frequency_penalty) }
                ...
                ///
                /// - Example: `100`
                public var max_tokens: Self.Key<Int> { .init(name: SemConv.gen_ai.request.max_tokens) }
                ...
                ///
                /// - Example: `gpt-4`
                public var model: Self.Key<String> { .init(name: SemConv.gen_ai.request.model) }
                ...
                ///
                /// - Example: `0.1`
                public var presence_penalty: Self.Key<Double> { .init(name: SemConv.gen_ai.request.presence_penalty) }
                ...
                ///
                /// - Type: stringArray
                public var stop_sequences: Self.Key<[String]> { .init(name: SemConv.gen_ai.request.stop_sequences) }
                ...
                ///
                /// - Example: `0.0`
                public var temperature: Self.Key<Double> { .init(name: SemConv.gen_ai.request.temperature) }
                ...
                ///
                /// - Example: `1.0`
                public var top_k: Self.Key<Double> { .init(name: SemConv.gen_ai.request.top_k) }
                ...
                ///
                /// - Example: `1.0`
                public var top_p: Self.Key<Double> { .init(name: SemConv.gen_ai.request.top_p) }
            }
        }
        ...
        public struct ResponseAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Type: stringArray
                public var finish_reasons: Self.Key<[String]> { .init(name: SemConv.gen_ai.response.finish_reasons) }
                ...
                public var id: Self.Key<String> { .init(name: SemConv.gen_ai.response.id) }
                ...
                ///
                /// - Example: `gpt-4-0613`
                public var model: Self.Key<String> { .init(name: SemConv.gen_ai.response.model) }
            }
        }
        ...
        public struct TokenAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `input`
                ///     - `output`
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.gen_ai.token.type) }
        ...
        public struct UsageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var completion_tokens: Self.Key<Int> { .init(name: SemConv.gen_ai.usage.completion_tokens) }
                ...
                ///
                /// - Example: `100`
                public var input_tokens: Self.Key<Int> { .init(name: SemConv.gen_ai.usage.input_tokens) }
                ...
                ///
                /// - Example: `180`
                public var output_tokens: Self.Key<Int> { .init(name: SemConv.gen_ai.usage.output_tokens) }
                ...
                public var prompt_tokens: Self.Key<Int> { .init(name: SemConv.gen_ai.usage.prompt_tokens) }
            }
        }
    }
}
