...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct ServiceAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var name: Self.Key<String> { .init(name: SemConv.service.name) }
            ...
            ///
            /// - Example: `Shop`
            public var namespace: Self.Key<String> { .init(name: SemConv.service.namespace) }
            ...
            ///     - `2.0.0`
            ///     - `a01dbef8a`
            public var version: Self.Key<String> { .init(name: SemConv.service.version) }
        }
        ...
        public struct InstanceAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.service.instance.id) }
            }
        }
    }
}
