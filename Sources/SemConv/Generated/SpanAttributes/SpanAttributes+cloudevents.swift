...
public extension SpanAttributes {
    ...
    var cloudevents: CloudeventsAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct CloudeventsAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `0001`
            public var event_id: Self.Key<String> { .init(name: SemConv.cloudevents.event_id) }
            ...
            ///     - `my-service`
            public var event_source: Self.Key<String> { .init(name: SemConv.cloudevents.event_source) }
            ...
            ///
            /// - Example: `1.0`
            public var event_spec_version: Self.Key<String> { .init(name: SemConv.cloudevents.event_spec_version) }
            ...
            public var event_subject: Self.Key<String> { .init(name: SemConv.cloudevents.event_subject) }
            ...
            public var event_type: Self.Key<String> { .init(name: SemConv.cloudevents.event_type) }
        }
    }
}
