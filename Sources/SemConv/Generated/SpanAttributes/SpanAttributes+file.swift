...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct FileAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var accessed: Self.Key<String> { .init(name: SemConv.file.accessed) }
            ...
            public var attributes: Self.Key<[String]> { .init(name: SemConv.file.attributes) }
            ...
            ///
            /// - Example: `2021-01-01T12:00:00Z`
            public var changed: Self.Key<String> { .init(name: SemConv.file.changed) }
            ...
            ///
            /// - Example: `2021-01-01T12:00:00Z`
            public var created: Self.Key<String> { .init(name: SemConv.file.created) }
            ...
            public var directory: Self.Key<String> { .init(name: SemConv.file.directory) }
            ...
            ///     - `png`
            ///     - `gz`
            public var `extension`: Self.Key<String> { .init(name: SemConv.file.extension) }
            ...
            public var fork_name: Self.Key<String> { .init(name: SemConv.file.fork_name) }
            ...
            ///
            /// - Example: `256383`
            public var inode: Self.Key<String> { .init(name: SemConv.file.inode) }
            ...
            ///
            /// - Example: `0640`
            public var mode: Self.Key<String> { .init(name: SemConv.file.mode) }
            ...
            ///
            /// - Example: `2021-01-01T12:00:00Z`
            public var modified: Self.Key<String> { .init(name: SemConv.file.modified) }
            ...
            ///
            /// - Example: `example.png`
            public var name: Self.Key<String> { .init(name: SemConv.file.name) }
            ...
            public var path: Self.Key<String> { .init(name: SemConv.file.path) }
            ...
            ///
            /// - Type: int
            public var size: Self.Key<Int> { .init(name: SemConv.file.size) }
        }
        ...
        public struct GroupAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `1000`
                public var id: Self.Key<String> { .init(name: SemConv.file.group.id) }
                ...
                ///
                /// - Example: `users`
                public var name: Self.Key<String> { .init(name: SemConv.file.group.name) }
            }
        }
        ...
        public struct OwnerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Example: `1000`
                public var id: Self.Key<String> { .init(name: SemConv.file.owner.id) }
                ...
                ///
                /// - Example: `root`
                public var name: Self.Key<String> { .init(name: SemConv.file.owner.name) }
            }
        }
        ...
        public struct SymbolicLinkAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var target_path: Self.Key<String> { .init(name: SemConv.file.symbolic_link.target_path) }
            }
        }
    }
}
