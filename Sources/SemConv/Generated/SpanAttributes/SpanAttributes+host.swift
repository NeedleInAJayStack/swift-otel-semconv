...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct HostAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `x86`: 32-bit x86
            public var arch: Self.Key<ArchEnum> { .init(name: SemConv.host.arch) }
            ...
            public var id: Self.Key<String> { .init(name: SemConv.host.id) }
            ...
            public var ip: Self.Key<[String]> { .init(name: SemConv.host.ip) }
            ...
            public var mac: Self.Key<[String]> { .init(name: SemConv.host.mac) }
            ...
            public var name: Self.Key<String> { .init(name: SemConv.host.name) }
            ...
            public var type: Self.Key<String> { .init(name: SemConv.host.type) }
        }
        ...
        public struct CpuAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `6`
                ///     - `PA-RISC 1.1e`
                public var family: Self.Key<String> { .init(name: SemConv.host.cpu.family) }
                ...
                ///     - `1`
                ///     - `r1p1`
                public var stepping: Self.Key<String> { .init(name: SemConv.host.cpu.stepping) }
            }
            ...
            public struct CacheAttributes: SpanAttributeNamespace {
                ...
                public struct L2Attributes: SpanAttributeNamespace {
                    ...
                    public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                        ...
                        ///
                        /// - Example: `12288000`
                        public var size: Self.Key<Int> { .init(name: SemConv.host.cpu.cache.l2.size) }
                    }
                }
            }
            ...
            public struct ModelAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `6`
                    ///     - `9000/778/B180L`
                    public var id: Self.Key<String> { .init(name: SemConv.host.cpu.model.id) }
                    ...
                    public var name: Self.Key<String> { .init(name: SemConv.host.cpu.model.name) }
                }
            }
            ...
            public struct VendorAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var id: Self.Key<String> { .init(name: SemConv.host.cpu.vendor.id) }
                }
            }
        }
        ...
        public struct ImageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: SemConv.host.image.id) }
                ...
                public var name: Self.Key<String> { .init(name: SemConv.host.image.name) }
                ...
                ///
                /// - Example: `0.1`
                public var version: Self.Key<String> { .init(name: SemConv.host.image.version) }
            }
        }
    }
}
