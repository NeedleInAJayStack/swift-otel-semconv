...
public extension SpanAttributes {
    ...
    @dynamicMemberLookup
    struct JvmAttributes: SpanAttributeNamespace {
        ...
        public struct BufferAttributes: SpanAttributeNamespace {
            ...
            public struct PoolAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `mapped`
                    ///     - `direct`
                    public var name: Self.Key<String> { .init(name: SemConv.jvm.buffer.pool.name) }
                }
            }
        }
        ...
        public struct GcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `end of minor GC`
                ///     - `end of major GC`
                public var action: Self.Key<String> { .init(name: SemConv.jvm.gc.action) }
                ...
                ///     - `G1 Young Generation`
                ///     - `G1 Old Generation`
                public var name: Self.Key<String> { .init(name: SemConv.jvm.gc.name) }
            }
        }
        ...
        public struct MemoryAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `heap`
                ///     - `non_heap`
                public var type: Self.Key<TypeEnum> { .init(name: SemConv.jvm.memory.type) }
            ...
            public struct PoolAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `G1 Eden space`
                    ///     - `G1 Survivor Space`
                    public var name: Self.Key<String> { .init(name: SemConv.jvm.memory.pool.name) }
                }
            }
        }
        ...
        public struct ThreadAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// - Type: boolean
                public var daemon: Self.Key<Bool> { .init(name: SemConv.jvm.thread.daemon) }
                ...
                ///     - `runnable`
                ///     - `blocked`
                public var state: Self.Key<StateEnum> { .init(name: SemConv.jvm.thread.state) }
