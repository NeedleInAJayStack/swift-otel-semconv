...
public extension SpanAttributes {
    /// `webengine` namespace
    var webengine: WebengineAttributes {
        get {
    ...
    @dynamicMemberLookup
    struct WebengineAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var description: Self.Key<String> { .init(name: SemConv.webengine.description) }
            ...
            ///
            /// - Example: `WildFly`
            public var name: Self.Key<String> { .init(name: SemConv.webengine.name) }
            ...
            ///
            /// - Example: `21.0.0`
            public var version: Self.Key<String> { .init(name: SemConv.webengine.version) }
        }
    }
}
